...
public class Tester {
    public static void main(String[] args) {
        ...
        System.out.println("P1 id: " + p1.getP_id() + p1.getName());
        System.out.println("P2 id: " + p2.getP_id() + p2.getName());
        ...
        for (Fee f: fees){
            System.out.println(f.getPerson().getName() + ": " +  f.getAmount() + " kr, skal betales: "+ f.getPayDate() + ", adresse: " + f.getPerson().getAddress());
        }
        ...
        for (PersonStyleDTO ps : personDetails) {
            System.out.println("Navn: " + ps.getName() + " , " + ps.getYear() + " , " + ps.getStyleName());
        }
